          ...
          <div className="w-full max-w-md">
            <div className="text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Join ADONIS and discover premium fashion
              </p>
            </div>
            ...
            <form className="mt-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-2 block w-full border border-border bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:border-foreground focus:outline-none"
                      placeholder="John"
                    />
                  </div>
                  <div>
              ...
              <div className="flex items-start">
                <input
                  ...
                  type="checkbox"
                  required
                  className="mt-1 h-4 w-4 border-border text-foreground focus:ring-foreground"
                />
